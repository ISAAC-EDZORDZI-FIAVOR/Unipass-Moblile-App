...
import app.codestudioapps.learing.app.adapters.DetailPagerAdapter;
import app.codestudioapps.learing.app.data.constant.AppConstant;
import app.codestudioapps.learing.app.data.sqlite.FavoriteDbController;
import app.codestudioapps.learing.app.models.favorite.FavoriteModel;
import app.codestudioapps.learing.app.utility.AdsUtilities;
import app.codestudioapps.learing.app.utility.TtsEngine;
            ...
            public void onClick(View view) {
                ...
                sendIntent.putExtra(Intent.EXTRA_TEXT, Html.fromHtml(mItemList.get(mViewPager.getCurrentItem()))
                       ...
                       // + " https://play.google.com/store/apps/details?id=" + appPackageName
                        + " https://play.google.com/store/apps/details?id= blackcodeStudio Apps"  );
