...
import app.codestudioapps.learing.app.adapters.ResultAdapter;
    ...
    public void initListener() {
        mBtnShare.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                sendIntent.putExtra(Intent.EXTRA_TEXT, getString(R.string.sharing_text, mScore) + " https://play.google.com/store/apps/details?id=" + "blackcodeStudio Apps");
                ;
